from wordjumble import  solve_word_jumble
...
def test_solve_word_jumble_1():
    ...
    assert solve_word_jumble(letters, circles, final) == ['tn', 'kisnsi']
def test_solve_word_jumble_2():
    ...
    final = ['OOOO', 'OOO']
    # solve_word_jumble(letters, circles, final)
    assert solve_word_jumble(letters, circles, final) == ['tumu', 'tht']
def test_solve_word_jumble_3():
    ...
    final = ['OOOOO', 'OOOOO']
    # solve_word_jumble(letters, circles, final)
    assert solve_word_jumble(letters, circles, final) == ['liarr', 'rerot']
