    ...
    while index >= 0 and i < len(text):
        ...
        if text[i].isalpha() and text[index].isalpha():
            ...
            if text[i] == text[index]:
                ...
                return False
        elif text[i].isalpha() and text[index].isalpha() == False:
            print("i alpha")
            print(text[i], text[index])
            index -= 1
        elif text[i].isalpha() == False and text[index].isalpha():
            print("index isalpha")
            print(text[i], text[index])
            i += 1
        elif text[i].isalpha() == False and text[index].isalpha() == False:
            index -= 1
            i += 1
    return True
...
if __name__ == '__main__':
    main()
    # print(is_palindrome_iterative('Race, rtaR!'))
